...
func main() {
	...
	var marathonInMiles = marathonInKM / mileInKM // Umrechnung von Kilometern in Meilen
	fmt.Printf("a marathon is %.2f kilometres = %.2f miles long\n", marathonInKM, marathonInMiles)

	var boilingWaterCelsius = 100.0
	var boilingWaterFahrenheit = (boilingWaterCelsius * 9 / 5) + 32 // Umrechnung von Celsius in Fahrenheit
